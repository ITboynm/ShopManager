<template>
  <FormDrawer title="设置商品规格" ref="formDrawerRef" destroyOnClose @submit="handleSubmit"
    ...
    <el-form :model="skusForm">
      ...
      <template v-if="!skusForm.sku_type">
        <el-form-item label="市场价格">
          <el-input v-model="skusForm.sku_value.oprice" placeholder="请输入市场价格" style="width: 50%">
            <template #append>元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="销售价格">
          <el-input v-model="skusForm.sku_value.pprice" placeholder="请输入销售价格" style="width: 50%">
            <template #append>元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="成本价格">
          <el-input v-model="skusForm.sku_value.cprice" placeholder="请输入成本价格" style="width: 50%">
            <template #append>元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="商品重量">
          <el-input v-model="skusForm.sku_value.weight" placeholder="请输入商品重量" style="width: 50%">
            <template #append>公斤</template>
          </el-input>
        </el-form-item>
        <el-form-item label="商品体积">
          <el-input v-model="skusForm.sku_value.volume" placeholder="请输入商品体积" style="width: 50%">
