              ...
              <div class="flex-1">
                ...
                <div v-if="row.textareaEdit">
                  ...
                  <div class="py-2">
                    ...
                    <el-button size="small" class="ml-2" @click="closeReview(row)">取消</el-button>
                  </div>
                </div>
        ...
        <el-table-column label="商品" width="250">
          <template #default="{ row }">
            <div class="flex items-center">
              <el-image :src="row.goods_item ? row.goods_item.cover : ''" :lazy="true" fit="cover"
                style="height: 50px;width: 50px;" class="rounded"></el-image>
              <div class="ml-3">
...
const review = async (row) => {
  ...
  const res = await fetchData(commentApi.reviewGoodsComment, {
    fetchId: row.id,
